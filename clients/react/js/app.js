      ...
      render:function(){
        ...
        if(this.state.game_state == "ENGAGE"){
          if(this.state.fire_mode == "random"){
            btn_random = React.createElement("button", {className: "btn btn-danger active", onClick: this.fireMode.bind(this,'')}, "Disable Random")
          }else{
            btn_random = React.createElement("button", {className: "btn btn-danger", onClick: this.fireMode.bind(this,'random')}, "Random Fire")
          }
        }
        return(
